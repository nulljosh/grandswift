...
cdo.set_editor_property("MissionNames", ["Smash into the Apple Store and grab the laptops", "Lose the heat: run to the Art Gallery steps", "Rob the 7-Eleven on Granville", "Get to Waterfront Station before the cops"])
