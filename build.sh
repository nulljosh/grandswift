...
set -e
cd "$(dirname "$0")"
pkill -x vancouvervice || true
swiftc -O -parse-as-library main.swift -o vancouvervice
A="Vancouver Vice.app/Contents"; rm -rf "Vancouver Vice.app"; mkdir -p "$A/MacOS" "$A/Resources"
cp vancouvervice "$A/MacOS/vancouvervice"
GS_ICON=/tmp/gs_icon.png ./vancouvervice
