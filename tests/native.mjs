...
const shells = { windows: "apps/windows/App.cs", linux: "apps/linux/main.c", apple: "apps/apple/App.swift", android: "apps/android/app/src/main/java/com/jaybulb/rainjack/MainActivity.java" };
let fail = 0;
