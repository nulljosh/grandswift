...
A third person GTA-style game set in Vancouver and Victoria, written as one SwiftUI + SceneKit file for macOS.
...
## Controls
W A S D or arrows to move, mouse to look (click to lock), Esc to pause, F for full screen, Space or click to shoot, E to get in or out of a car, Tab to switch between Joshua and Alexandre.
